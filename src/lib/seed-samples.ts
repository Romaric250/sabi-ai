          ...
          quiz: [
            {
              ...
              correct: 0,
              explanation:
                "Use vertex formula: x = -b/2a = 4/2 = 2, then y = 4 - 8 + 3 = -1",
            },
          ],
          position: { x: 1, y: 1 },
      ...
      stages: [
        {
          ...
          title: "Cell Theory",
          description:
            "Understanding the fundamental principles of cell biology",
          lessons: [
          ...
          quiz: [
            {
              ...
              correct: 0,
              explanation:
                "Robert Hooke first observed cork cells under a microscope in 1665",
            },
          ],
          position: { x: 2, y: 0 },
