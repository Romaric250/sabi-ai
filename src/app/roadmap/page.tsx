  ...
  const generateRoadmap = async () => {
    ...
    try {
      ...
      if (data.success) {
        ...
        const newNodes: Node[] = data.roadmap.map(
          (item: RoadmapNode, index: number) => ({
            id: item.id,
            type: "custom",
            position: {
              x: (index % 3) * 250 + 100,
            ...
            data: {
              ...
              quiz: item.quiz,
              status:
                index === 0 ? "completed" : index === 1 ? "current" : "locked",
            },
          })
        );
          ...
          {nodes.length === 0 && !isGenerating && (
            ...
            >
              ...
              <p className="text-gray-400 max-w-md mx-auto">
                Enter what you want to learn above and our AI will generate a
