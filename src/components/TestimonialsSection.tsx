...
const testimonials = [
  {
    ...
    avatar: "AC",
    content:
      "The AI-powered roadmaps are incredibly detailed and personalized. I went from zero to landing my dream job at Google in just 8 months following the Full-Stack Development path.",
    rating: 5,
  ...
  },
  {
    ...
    avatar: "MR",
    content:
      "The interactive quizzes and visual learning approach made complex machine learning concepts so much easier to understand. The progress tracking kept me motivated throughout.",
    rating: 5,
  ...
  },
  {
    ...
    avatar: "DK",
    content:
      "What sets this platform apart is how it adapts to your learning style. The AI noticed I was struggling with Kubernetes and automatically provided additional resources and practice.",
    rating: 5,
  ...
  },
  {
    ...
    avatar: "ST",
    content:
      "The gamification elements and achievement system made learning addictive in the best way. I completed my entire UX/UI roadmap 3 weeks ahead of schedule!",
    rating: 5,
  ...
  },
  {
    ...
    avatar: "JW",
    content:
      "The community features are amazing. Being able to connect with other learners on similar paths and share progress created an incredible support network.",
    rating: 5,
  ...
  },
  {
    ...
    avatar: "ED",
    content:
      "The platform's ability to generate roadmaps for emerging technologies like blockchain and Web3 is unmatched. It's always up-to-date with industry trends.",
    rating: 5,
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        >
          ...
          <p className="text-xl text-gray-300 max-w-3xl mx-auto">
            Real learners, real results. See how our AI-powered platform has
        ...
        <div className="relative max-w-4xl mx-auto mb-16">
          ...
          >
            <div className="bg-slate-800/50 backdrop-blur-sm rounded-3xl border border-slate-700/50 p-8 md:p-12">
              ...
              >
                <div
                  className={`w-12 h-12 bg-gradient-to-r ${testimonials[currentIndex].gradient} rounded-full flex items-center justify-center`}
                >
              ...
              <div className="pt-6">
                ...
                >
                  <div
                    className={`w-16 h-16 bg-gradient-to-r ${testimonials[currentIndex].gradient} rounded-full flex items-center justify-center`}
                  >
