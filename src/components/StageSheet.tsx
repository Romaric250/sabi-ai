      ...
      <Sheet open={isOpen} onOpenChange={onClose}>
        ...
        >
          ...
          <div className="h-full flex flex-col relative">
            {/* Header */}
            <div
              className={`p-6 bg-gradient-to-r ${stage.color} text-white relative`}
            >
              <SheetHeader>
            ...
            <div className="flex border-b border-gray-200">
              {[
                ...
                <button
                  ...
                  onClick={() =>
                    setCurrentTab(
                      id as "lessons" | "materials" | "quiz" | "chat"
                    )
                  }
                ...
                {currentTab === "chat" && (
                  ...
                  >
                    ...
                    <p className="text-sm text-gray-600 mb-4">
                      Ask questions about <strong>{stage.title}</strong> and get
                      instant help from your AI tutor.
                    </p>
                      ...
                      <>
                        ...
                        <div className="p-6 bg-gray-50 rounded-xl border border-gray-200">
                          ...
                          <div className="space-y-3">
                            {stage.quiz[currentQuizIndex].options.map(
                              (option, index) => (
                                <motion.button
                                  key={index}
                                  ...
                                  className={`w-full p-4 text-left rounded-xl border transition-all ${
                                    selectedAnswer === null
                                      ...
                                      ? index ===
                                        stage.quiz[currentQuizIndex].correct
                      ...
                      <div className="text-center space-y-6">
                        ...
                        <div>
                          ...
                          <p className="text-gray-600">
                            You got {quizResults.filter(Boolean).length} out of{" "}
                            {stage.quiz.length} questions correct.
                          </p>
                        </div>
            ...
            <div className="p-6 border-t border-gray-200 bg-gray-50 flex items-center justify-center">
              <div className="text-sm text-gray-500">
                Stage {stage.id} • {stage.lessons.length} lessons •{" "}
                {stage.quiz.length} questions
              </div>
            </div>
          </div>
        </SheetContent>
